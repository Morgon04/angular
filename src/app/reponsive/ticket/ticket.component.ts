...
import { Button } from '../_model/button';
import { Tickets } from '../_model/tickets';
import { Recommend } from './../_model/recommend';
...
export class TicketComponent implements OnInit {
  ...
  public btnList: Button[] = [];
  public recommentList: Recommend[] = [];
  ...
  public ngOnInit(): void {
    this.initializeTicketList();
    this.initializeBtnList();
    this.initializeRecommendList();
    this.initializeDataList();
  }

  // Initializing Ticket List
  public initializeTicketList(): void {
  ...
  // Initializing Btn list
  public initializeBtnList(): void {
    this.btnList = [...this.btnList,
    { name: 'All', selected: true },
    { name: 'Unread' }, { name: 'Important' }
    ];
  }

  // Initializing Recommend List
  public initializeRecommendList(): void {
    this.recommentList = [...this.recommentList, {
      heading: 'Lifestyle Magazines',
      description: `A lifestyle magazine is a popular magazine concerned with lifestyle.
       It includes a number of men\`s magazines, women\`s magazines and magazines about
       health...`,
      comment: 22,
      like: 133,
      stars: 3
  ...
  public initializeDataList(): void {
    this.datalist = [...this.datalist, {
      heading: 'Literature',
      count: 23.50,
      percentage: 75
    }, {
      heading: 'Fashion Class',
      count: 23.50,
      percentage: 45
    }];
  }

  // Highlighting Selected Ticket
  public markTicketSelected(ticket: Tickets): void {
    this.ticketsList.forEach((tl) => {
      if (tl.name !== ticket.name) {
        tl.selected = false;
      }
    });
  ...
  // Highlighting Selected Btn
  public markBtnSelected(btn: any): void {
    this.btnList.forEach((tl) => tl.selected = false);
