...
export class TaskManagementDashboardComponent implements OnInit {
  ...
  // side nav list
  sidenavList: { [key: string]: any }[] = [];

  // tasks Items
  taskItems: { [key: string]: any }[] = [];

  // my task items
  mytaskItesm: { [key: string]: any }[] = [];

  // todo list
  mytodoList: { [key: string]: any }[] = [];
  ...
  public ngOnInit(): void {
    ...
    this.mobileQuery.addEventListener('change', this.sideNavState);
    this.initializeSidenavList();
    this.initializeTaskItems();
    this.initializeMyTasks();
    this.initializeTodosList();
    this.constructDays();
    this.initializeMessagesList();
  }
  ...
  public initializeSidenavList(): void {
    this.sidenavList = [...this.sidenavList,
    {
      name: 'Dashboard',
      icon: 'dashboard',
      isActive: true
  ...
  public initializeTaskItems(): void {
    this.taskItems = [...this.taskItems,
    {
      icon: 'https://img-authors.flaticon.com/google.jpg',
      title: 'Google',
      subTitle: 'Google inc.',
      ...
      completionDate: 'Due Date: 20 JUNE'
    },
    {
      icon: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQE9dSEZkxPmI8o8iiLJ1DVSIAkzfy-F3in4VjHzHQ&usqp=CAU',
      title: 'Slack',
      subTitle: 'Slack corporation',
      progress: 'Completed',
      priority: 'Medium Priority',
      taskStatus: '30/30',
      taskProgess: 75,
      listOfApps: ['IOS APP', "ANDROID"],
      images: [
        'data:image/jpeg;base64,',
        'data:image/jpeg;base64,',
        'data:image/jpeg;base64,',
  ...
  public initializeMyTasks(): void {
    this.mytaskItesm = [...this.mytaskItesm,
    {
      name: 'R&D about React Lifecycle',
      isCompleted: false,
    },
    {
    ...
    {
      name: 'Work on CSS transform',
      isCompleted: false,
    },
    {
      name: 'Create pure CSS Website',
      isCompleted: true,
    },
    {
      name: 'Logo Design',
    ...
    {
      name: 'Work on Dark/Light theme',
      isCompleted: false
    }
    ]
  }

  public getNotCompletedTasksCount(): number {
    return this.mytaskItesm.filter(m => !m.isCompleted).length;
  }

  public initializeTodosList(): void {
  ...
  public initializeMessagesList(): void {
  ...
  public darkTheme(event: MatSlideToggleChange): void {
